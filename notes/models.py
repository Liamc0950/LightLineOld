...
class Note(models.Model):
    ...
    assignedTo = models.ForeignKey(Profile, related_name="assignedTo", on_delete=models.CASCADE)
    #Profile of the user who last updated this note
    lastUpdatedBy = models.ForeignKey(Profile, related_name="lastUpdatedBy", on_delete=models.CASCADE)
