...
class AuthenticationAppConfig(AppConfig):
    name = 'lightline.lightlineapp.authentication'
    label = 'authentication'
    verbose_name = 'Authentication'

    def ready(self):
        import lightline.lightlineapp.authentication.signals
...
default_app_config = 'lightline.lightlineapp.authentication.AuthenticationAppConfig'
