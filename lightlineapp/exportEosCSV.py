    ...
    def printTest(self):    
        ...
        for cue in cues:
            if cue.getHeader() != None:
                ...
                style.add('BACKGROUND',(0, i), (4, i), colors.palegreen)
                cueTableData.append([cue.eosCueNumber, cue.cueLabel, cue.pageNumber, cue.cueTime, cue.cueDescription])
                i+=2
            else:
                cueTableData.append([cue.eosCueNumber, cue.cueLabel, cue.pageNumber, cue.cueTime, cue.cueDescription])
                i+=1
        ...
        cueTable = Table(cueTableData, colWidths=[colUnit * 1, colUnit * 3, colUnit * 1, colUnit * 1, colUnit * 4])
